var mapStyle = {
  ...
  "sources": {"mapbox": {"url": "mapbox://mapbox.mapbox-streets-v7", "type": "vector"}},
  ...
  "layers": [{
    ...
    "paint": {"fill-color": "#d8e8c8", "fill-opacity": 0.75},
    ...
    "source-layer": "landuse",
    "filter": ["==", "class", "wood"],
    "paint": {"fill-color": "#6a4", "fill-opacity": 0.1},
    "metadata": {"mapbox:group": "1444849388993.3071"},
    "interactive": true
  }, {
    "interactive": true,
    ...
    "source": "mapbox",
    "id": "waterway",
    "paint": {"line-color": "#a0c8f0", "line-width": {"base": 1.3, "stops": [[13, 0.5], [20, 2]]}},
    ...
    "id": "water_offset",
    "paint": {"fill-color": "white", "fill-opacity": 0.3, "fill-translate": [0, 2.5]},
    "metadata": {"mapbox:group": "1444849382550.77"},
    "interactive": true,
    "ref": "water"
  }, {
    ...
    "paint": {"fill-color": {"base": 1, "stops": [[15.5, "#f2eae2"], [16, "#dfdbd7"]]}},
    ...
    "paint": {
      ...
      "line-width": {"base": 1.2, "stops": [[12, 1], [13, 3], [14, 4], [20, 15]]},
      "line-opacity": 1
    },
    "source-layer": "road"
  }, {
    ...
    "paint": {
      "line-color": "#cfcdca",
      "line-width": {"base": 1.2, "stops": [[12, 0.5], [13, 1], [14, 4], [20, 15]]},
    ...
    "paint": {"line-color": "#e9ac77", "line-width": {"base": 1.2, "stops": [[8, 1.5], [20, 17]]}, "line-opacity": 1},
    "source-layer": "road"
  }, {
    "interactive": true,
    "layout": {"line-join": "round"},
    ...
    "paint": {"line-color": "#e9ac77", "line-width": {"base": 1.2, "stops": [[5, 0.4], [6, 0.6], [7, 1.5], [20, 22]]}},
    "source-layer": "road"
  }, {
    "interactive": true,
    "layout": {"line-join": "round", "visibility": "visible"},
    ...
    "paint": {
      "line-color": "#e9ac77",
      "line-dasharray": [0.5, 0.25],
      "line-width": {"base": 1.2, "stops": [[5, 0.4], [6, 0.6], [7, 1.5], [20, 22]]}
    },
    "source-layer": "road"
  }, {
    ...
    "paint": {
      "line-color": "#fc8",
      "line-width": {"base": 1.2, "stops": [[12.5, 0], [13, 1.5], [14, 2.5], [20, 11.5]]}
    },
    ...
    "paint": {"line-color": "#fff4c6", "line-width": {"base": 1.2, "stops": [[6.5, 0], [7, 0.5], [20, 18]]}},
    "ref": "tunnel_trunk_primary_casing"
  }, {
    "interactive": true,
    "metadata": {"mapbox:group": "1444849354174.1904"},
    "id": "tunnel_motorway",
    "paint": {"line-color": "#ffdaa6", "line-width": {"base": 1.2, "stops": [[6.5, 0], [7, 0.5], [20, 18]]}},
    ...
    "paint": {"line-color": "#fea", "line-width": {"base": 1.2, "stops": [[6.5, 0], [7, 0.5], [20, 18]]}},
    "ref": "road_trunk_primary_casing"
  }, {
    "interactive": true,
    "metadata": {"mapbox:group": "1444849345966.4436"},
    "id": "road_motorway",
    "paint": {"line-color": "#fc8", "line-width": {"base": 1.2, "stops": [[6.5, 0], [7, 0.5], [20, 18]]}},
    ...
    "source": "mapbox",
    "id": "admin_level_2",
    "paint": {"line-color": "#9e9cab", "line-width": {"base": 1, "stops": [[4, 1.4], [5, 2], [12, 8]]}},
    "source-layer": "admin"
  }, {
    "interactive": true,
    "layout": {"line-cap": "round"},
    ...
    "source": "mapbox",
    "id": "road_label",
    "paint": {"text-color": "#765", "text-halo-width": 1, "text-halo-blur": 0.5},
